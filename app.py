...
# ── Custom Cliniva Medical UI CSS Styles ───────────────────────────────────────
st.markdown("""
<style>
...
with tab3:
    ...
    if active_record["coach_recommendation"]:
        ...
        # ── Pollinations AI — Visual Health Reference ─────────────────────────
        # Selects an illustration topic based on the most prominent biometric
        # flag, then loads a free Flux-model image from pollinations.ai.
        # No API key required — the URL is self-contained.
        with st.expander("🎨 Visual Health Reference  *(powered by Pollinations AI)*", expanded=True):
            st.caption(
                "AI-generated educational medical illustration — for reference only, not a diagnostic image. "
                "Powered by [Pollinations AI](https://pollinations.ai) (Flux model, free & open)."
            )
            ...
            st.image(
                _pollinations_url,
                caption=f"🖼️ {_img_label} — Generated by Pollinations AI (Flux model)",
